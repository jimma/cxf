    ...
    */
    ...
    public static void setMinimumEscapeHandler(Marshaller marshaller) {
        ...
        try {
            ...
            Class handlerClass = Class.forName("com.sun.xml" + internal
                                               + ".bind.marshaller.MinimumEscapeHandler");
            Class handlerInterface = Class.forName("com.sun.xml" + internal
                                                   + ".bind.marshaller.CharacterEscapeHandler");
            Object targetHandler = handlerClass.getField("theInstance").get(null);
            Object escapeHandler = getEscapeHandlerInstance(marshaller.getClass().getClassLoader(), new Class[] {
                handlerInterface }, new EscapeHandlerInvocationHandler(targetHandler));
    ...
    private synchronized static Object getEscapeHandlerInstance(ClassLoader loader, Class<?>[] interfaces,
